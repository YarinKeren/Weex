...
export async function addCar(req, res) {
    ...
    try {
        ...
        socketService.broadcast({ type: 'car-added', data: addedCar, userId: loggedinUser._id })
        res.json(addedCar)
    } catch (err) {
...
export async function removeCar(req, res) {
    ...
    try {
        ...
        socketService.broadcast({ type: 'car-removed', data: carId, userId: loggedinUser._id })
        res.send(removedId)
    } catch (err) {
